...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 41.4.3) (read-case-sensitive #t) (teachpacks ((lib "draw.ss" "teachpack" "htdp") (lib "arrow.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "draw.ss" "teachpack" "htdp") (lib "arrow.ss" "teachpack" "htdp")))))
...
(define (draw-losh losh)
  (begin
    (for-each draw-shape losh)
    true))

(define (clear-losh losh)
  (begin
    (for-each clear-shape losh)
    true))
...
(define (_move-picture delta picture)
  (map (lambda (p) (move-shape delta p)) picture))
