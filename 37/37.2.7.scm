...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 37.2.7) (read-case-sensitive #t) (teachpacks ((lib "gui.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "gui.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp")))))
...
(define (hangman-guess guess)
  (local ((define old-status status-word))
    (cond
