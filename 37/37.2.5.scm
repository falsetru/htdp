...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 37.2.5) (read-case-sensitive #t) (teachpacks ((lib "gui.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "gui.ss" "teachpack" "htdp") (lib "draw.ss" "teachpack" "htdp")))))
               ...
               (local ((define result (hangman-guess c)))
                 (begin
                   ...
                   (cond
                     ...
                     [(equal? (first result) "Good guess!") (void)])
                   )
                 )
               true))))
